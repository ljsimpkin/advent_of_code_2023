...
RSpec.describe '2/a tests' do
  xit 'get_answer inputs a string and returns a sum of the possble combinations' do
  ...
  xit 'is_possible returns true if puzzle meets criterea' do
    puzzle = "Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green"
    criterea = {red => 12, green => 13, blue => 14}

    result = get_first_and_last_numbers(puzzle, criterea)
